...
> **Note:** This guide applies to all axes (Both X, Y, and Z). The belt installation method is the same for each.

1. **Route the belt** around the motor pulley, idler, and guide as shown in the frame diagram.
   
2. **Attach the belt using apex clip to one side**:
...
3. **Route the belt through the pulley tensioner and to the other side**:
...
If you want, I can also **rewrite it in a super concise, “manual-style” version** that’s perfect for a one-page diagram with minimal text, which is ideal for assembly guides.
